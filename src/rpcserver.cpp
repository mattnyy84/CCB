...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop CryptoCashBack server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "CryptoCashBack server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* CCB features */
        {"cryptocashback", "masternode", &masternode, true, true, false},
        {"cryptocashback", "masternodelist", &masternodelist, true, true, false},
        {"cryptocashback", "mnbudget", &mnbudget, true, true, false},
        {"cryptocashback", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"cryptocashback", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"cryptocashback", "mnsync", &mnsync, true, true, false},
        {"cryptocashback", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"cryptocashback", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use cryptocashbackd, or the -server option to cryptocashback-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> cryptocashback-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:19552/\n";
}
