                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("CryptoCashBack-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CryptoCashBack address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cryptocashback: URIs)"));
...
//AAAA LimxDev Coinmix Tab	
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About CryptoCashBack Core"), this);
    aboutAction->setStatusTip(tr("Show information about CryptoCashBack Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for CryptoCashBack"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CryptoCashBack addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CryptoCashBack addresses"));
    ...
    openAction->setStatusTip(tr("Open a CryptoCashBack: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the CryptoCashBack Core help message to get a list with possible CryptoCashBack command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("CryptoCashBack Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CryptoCashBack network", "", count));
}
...
{
    QString strTitle = tr("CryptoCashBack Core"); // default title
