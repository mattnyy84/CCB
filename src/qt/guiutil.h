...
/** Utility functions used by the CCB Qt UI.
 */
namespace GUIUtil
{
...
// Render CCB addresses in monospace font
...
// Parse "cryptocashback:" URI into recipient object, return true on successful parsing
