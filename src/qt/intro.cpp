...
void Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("CryptoCashBack Core"),
     ...
     * override -datadir in the cryptocashback.conf file in the default data directory
     * (to be consistent with cryptocashbackd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
