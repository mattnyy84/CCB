/* src/config/cryptocashback-config.h.  Generated from cryptocashback-config.h.in by configure.  */
/* src/config/cryptocashback-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://cryptocashback.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "CryptoCashBack Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "CryptoCashBack Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "cryptocashback"
