...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("CryptoCashBack Core cryptocashback-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  cryptocashback-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cryptocashback transaction") + "\n" +
                               "  cryptocashback-tx [options] -create [commands]   " + _("Create hex-encoded cryptocashback transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded cryptocashback transaction
